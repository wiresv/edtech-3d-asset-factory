...
const tones: Record<Tone, { bg: string; fg: string; dot: string }> = {
  ...
  neutral:{ bg: "bg-surface",          fg: "text-ink-2",         dot: "bg-muted-2" },
};
...
export default function PillBadge({
  ...
  return (
    <span
      className={
        `inline-flex items-center gap-1.5 rounded-pill px-2.5 py-0.5 text-[11.5px] font-semibold uppercase tracking-wider ${t.bg} ${t.fg} ` +
        className
      }
    >
